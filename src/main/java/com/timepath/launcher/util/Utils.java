...
public class Utils {
    ...
    public static final  String            UNAME          = MessageFormat.format("{0}@{1}",
    ...
    public static final  long              currentVersion = version();
        ...
        Runnable submit = new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    URL url = new URL("http://dbinbox.com/send/timepath/" + directory);
...
fallback:
        ...
        try {
            ...
            LOG.log(Level.INFO, "Set theme at {0}ms", System.currentTimeMillis() - START_TIME);
