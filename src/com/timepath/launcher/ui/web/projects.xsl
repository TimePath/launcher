...
<!-- http://dl.dropboxusercontent.com/u/42745598/www/projects.xml -->
...
<xsl:stylesheet	xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
				...
				<div class="container">
					...
					<div class="navbar-collapse collapse navbar-responsive-collapse">
						<ul class="nav navbar-nav navbar-left">
							<li class="active">
								<a href="#">
									<span class="glyphicon glyphicon-th-list"/> Programs <span class="badge">2</span>
								</a>
							</li>
							<li>
								<a href="#">About</a>
							...
							<li class="dropdown">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown">Extras<b class="caret"/></a>
						...
						<form class="navbar-form navbar-left" >
							<div class="form-group" role="search">
								<input type="text" class="form-control" placeholder="Search" id="search-apps" value="" autocomplete="off"/>
							</div>
						</form>
	...
	<xsl:template name="output-program">
		...
		<xsl:variable name="istr">prog<xsl:value-of select="$i"/></xsl:variable>
			...
			<xsl:if test="$progressProgram > 0">
				<div class="progress progress-striped active">
					<div class="progress-bar progress-bar-info">
						<xsl:attribute name="style">width: <xsl:value-of select="$progressProgram"/>%</xsl:attribute>
						<xsl:attribute name="class">progress-bar <xsl:value-of select="$progressProgramBarClass"/></xsl:attribute>
					</div>
				</div>
			</xsl:if>
		</xsl:variable>
			...
			<div class="btn-toolbar">
				<div class="pull-right">
					<div class="btn-group">
						...
						<a class="btn btn-default btn-sm disabled" role="button" data-placement="bottom" data-original-title="Remove">
					...
					<div class="btn-group">
						<a class="btn btn-default btn-sm" role="button" data-toggle="collapse" data-placement="left" data-original-title="Expand">
							<xsl:attribute name="href">#<xsl:value-of select="$istr"/></xsl:attribute>
		...
		<section class="dependencies">
			<div class="accordion-body collapse">
				...
				<xsl:for-each select="exsl:node-set($req)/depends/entry">
					<xsl:variable name="jstr">dep<xsl:value-of select="$i"/>-<xsl:value-of select="position()"/></xsl:variable>
		...
		<section>
			...
			<div class="row">
				...
				<div class="col-xs-2 col-sm-2 col-sm-push-8">
					<div class="pull-right">
						<a class="btn btn-default btn-sm" role="button" data-toggle="collapse" data-placement="left" data-original-title="Expand">
							<xsl:attribute name="href">#<xsl:value-of select="$jstr"/></xsl:attribute>
				...
				<div class="col-xs-12 col-sm-8 col-sm-pull-2">
					<xsl:if test="$downloading > 0">
						<div class="progress progress-striped active">
							<div>
								<xsl:attribute name="style">width: <xsl:value-of select="$progressLib"/>%</xsl:attribute>
								<xsl:attribute name="class">
							...
							<xsl:choose>
								...
								<xsl:when test="$progressFile >= 100">
									<span class="pull-right label label-success">
										<span class="glyphicon glyphicon-ok"/> Updated</span>
								</xsl:when>
								<xsl:when test="$progressFile >= 0">
									<span class="pull-right label label-info">
										<span class="glyphicon glyphicon-download-alt"/> Downloading</span>
								</xsl:when>
								<xsl:otherwise>
									<span class="pull-right label label-warning">
										<span class="glyphicon glyphicon-exclamation-sign"/> Update</span>
								</xsl:otherwise>
							</xsl:choose>
						</div>
						<div class="col-xs-12 col-sm-8 col-sm-pull-2">
							<div class="progress progress-striped active">
								<div>
									<xsl:attribute name="style">width: <xsl:value-of select="$progressFile"/>%</xsl:attribute>
									<xsl:attribute name="class">
